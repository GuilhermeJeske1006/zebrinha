                        ...
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3"
                                    data-thumb="{{ $admin_url . '/' . str_replace('public/', 'storage/', $produto->foto) }}">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="{{ $admin_url . '/' . str_replace('public/', 'storage/', $produto->foto) }}"
                                            alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                            href="{{ $admin_url . '/' . str_replace('public/', 'storage/', $produto->foto) }}">
                                ...
                                @foreach ($imagens as $img)
                                    <div class="item-slick3"
                                        data-thumb="{{ $admin_url . '/' . str_replace('public/', 'storage/', $img->imagem) }}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{ $admin_url . '/' . str_replace('public/', 'storage/', $img->imagem) }}"
                                                alt="IMG-PRODUCT">

                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                href="{{ $admin_url . '/' . str_replace('public/', 'storage/', $img->imagem) }}">
                                                <i class="fa fa-expand"></i>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <form method="POST" action="{{ route('adicionar_carrinho') }}">
                            ...
                            <div class="p-t-33">
                                <div class="flex-w flex-r-m p-b-10">
                                    ...
                                    <div class="size-204 respon6-next">
                                        <div class="rs1-select2 bor8 bg0">
                                            <select onchange="buscarTamanhoRelcionado()" class="js-select2"
                                                name="cor" id="cor">
                                ...
                                <div class="flex-w flex-r-m p-b-10">
                                    ...
                                    <div class="size-204 respon6-next">
                                        <div class="rs1-select2 bor8 bg0">
                                            <select onchange="atualizaQuantidadeMaxima()" class="js-select2"
                                ...
                                <div class="size-204 flex-w flex-m respon6-next">
                                    <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                        ...
                                        <input class="mtext-104 cl3 txt-center num-product" type="number"
                                            name="quantity" id="qtd" value="1" min="1">
                            ...
                            <div class="flex-w flex-r-m p-b-10" style="margin-bottom: 3%; display: block;">
                                <div class=" flex-c-m respon6 displayFrete" id="card"
            ...
            @else
                ...
                <div class="flex-w flex-m p-l-100 p-t-40 respon7">
                    ...
                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ Request::url() }}"
                        class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100" target="_blank"
    ...
    <div class="bor10 m-t-50 p-t-43 p-b-40">
        ...
        <div class="tab01">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item p-b-10">
                    <a class="nav-link" data-toggle="tab" href="#information" role="tab">Informação do
                        produto</a>
                </li>
                            ...
                            <div class="p-b-30 m-lr-15-sm">
                                ...
                                @if (Auth::check())
                                    <form action="{{ route('comentar') }}" method="POST" class="w-full">
                                        ...
                                        <p class="stext-102 cl6">
                                            Seu endereço de e-mail não será publicado. Os campos obrigatórios estão
                                            marcados*
                                        </p>
                                        ...
                                        <div class="flex-w flex-m p-t-50 p-b-23">
                                            ...
                                            <span class="wrap-rating fs-18 cl11 pointer">
                                                ...
                                                <i class="item-rating pointer zmdi zmdi-star-outline"></i>
                                                <i class="item-rating pointer zmdi zmdi-star-outline"></i>
                                                <input class="dis-none" type="number" name="estrela"
                                                    id="estrela">
                                            </span>
                                        </div>
                                ...
                                @if (Auth::guest())
                                    <p class="stext-102 cl6" style="text-align: center">
                                        <b> Se você quiser comentar por favor faça o <a
...
@section('scriptjs')
                ...
                .then(response => {
                    ...
                    for (let i = 0; i < response.data.length; i++) {
                        if(response.data[i].company.name == "Correios"){
                            if (response.data[i].error != "Serviço econômico indisponível para o trecho." && response.data[
                                i].price != undefined) {
    ...
    <script>
        function atualizaQuantidadeMaxima() {
            console.log('h4weoroewj p9dw')
            const tamanhoSelect = document.getElementById("tamanho");
            const quantidadeInput = document.getElementById("qtd");
            const maxQuantidade = parseInt(tamanhoSelect.options[tamanhoSelect.selectedIndex].dataset.quantidade);
            quantidadeInput.max = maxQuantidade;
            console.log(maxQuantidade, 'maxQuantidade')
    ...
    <script>
        function buscarTamanhoRelcionado() {
            const corSelecionada = document.querySelector('#cor').value
           ...
           <a style="text-align: center;
            ...
            `
                ...
                // Limpa o menu de tamanhos
                document.querySelector('#tamanho').innerHTML = '';

                // Preenche o menu de tamanhos com os valores retornados

                tamanhoSelect.insertAdjacentHTML('beforeend',
                    '<option value=""  data-quantidade="">Selecione o tamanho</option>');
            } else {
                axios.get(`/tamanhos-para-cor/${corSelecionada}/${produtoId}`)
                    .then(response => {
                        ...
                        response.data.forEach(tamanho => {
                            const optionHtml =
                                `<option value="${tamanho.tamanho}" data-quantidade="${tamanho.qtdTamanho}">${tamanho.tamanho}</option>`;
                            tamanhoSelect.insertAdjacentHTML('beforeend', optionHtml);
                        });
